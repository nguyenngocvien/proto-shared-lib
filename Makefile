...
proto_swagger:
	protoc --proto_path=. --openapiv2_out=../api-gateway/static/swagger --openapiv2_opt=allow_merge=true,merge_file_name=vcore-stack user/*.proto group/*.proto chat/*.proto workflow/*.proto

proto:
	protoc --proto_path=. --go_out=gen --go_opt=paths=source_relative --go-grpc_out=gen --go-grpc_opt=paths=source_relative --grpc-gateway_out=gen --grpc-gateway_opt=paths=source_relative --openapiv2_out=../api-gateway/static/swagger --openapiv2_opt=allow_merge=true,merge_file_name=swagger openapi/*.proto user/*.proto group/*.proto chat/*.proto workflow/*.proto